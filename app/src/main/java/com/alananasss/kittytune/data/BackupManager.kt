    ...
    object BackupManager {
        ...
        suspend fun createBackup(context: Context, uri: Uri) {
            withContext(Dispatchers.IO) {
                ...
                // Internal preference keys should remain hardcoded strings (technical keys)
        ...
        suspend fun restoreBackup(context: Context, uri: Uri) {
            withContext(Dispatchers.IO) {
                ...
                } ?: throw Exception(context.getString(R.string.error_backup_read)) // MODIFIED HERE
                ...
                // Internal preference keys should remain hardcoded strings
        ...
        private fun restorePrefs(context: Context, prefName: String, map: Map<String, Any?>) {
            ...
            map.forEach { (key, value) ->
                when (value) {
                    ...
                    is Double -> {
                        // Logic keys should remain hardcoded
        ...
        fun getBackupFileName(): String {
            ...
            // Filename format usually stays standard across languages for file system consistency
